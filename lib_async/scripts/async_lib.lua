...
ASYNC_SHOW_STATUS = "ASYNC_SHOW_STATUS"
...
function onInit()
	...
	OptionsManager.registerOption2(ASYNC_PRIORITY, true, "option_header_async_options", "label_option_SCHEDULE_FACTOR", "option_entry_cycler",
        { labels = "option_val_1|option_val_2|option_val_3|option_val_4|option_val_5|option_val_block|option_val_3n|option_val_2n|option_val_1n",
        values = "1|2|3|4|5|block|-3|-2|-1", baselabel = "option_val_auto", baseval = "auto", default = "auto" });
    OptionsManager.registerOption2(ASYNC_SHOW_STATUS, true, "option_header_async_options", "label_option_ASYNC_SHOW_STATUS", "option_entry_cycler",
...
function startAsync()
    setShowStatus(OptionsManager.getOption(ASYNC_SHOW_STATUS))
